  ...
  <a-layout>
    ...
    <a-layout>
      ...
      <a-layout-content :style="{ margin: '24px 16px', padding: '24px', background: '#fff', minHeight: '475px' }">
        ...
        <a-textarea v-model:value="title" placeholder="Autosize height based on content lines" auto-size />
        <div style="margin: 24px 0" />
        <span class="label">内容</span>
        <a-textarea v-model:value="content" placeholder="Autosize height with minimum and maximum number of lines"
